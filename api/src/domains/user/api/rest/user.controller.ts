...
import { parseSortValue } from '~/platform/application/sort';
...
import { CreateUserUseCase } from '~/domains/user/app/use-cases/create-user.use-case';
import { GetUserByIdUseCase } from '~/domains/user/app/use-cases/get-user-by-id.use-case';
import { ListUsersUseCase } from '~/domains/user/app/use-cases/list-users.use-case';
import { PermissionsGuard } from '~/domains/auth/api/guard/permissions.guard';
import {
  type UploadedAvatarFile,
  UpdateUserUseCase,
} from '~/domains/user/app/use-cases/update-user.use-case';
import {
  buildListUsersQuery,
