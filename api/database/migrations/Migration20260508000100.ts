...
export class Migration20260508000100 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `alter table "user_credentials"
        add constraint "user_credentials_user_id_unique" unique ("user_id");`,
    );
    ...
    this.addSql(
      `create index "user_sessions_revoked_at_index"
    ...
    this.addSql(
      `create index "email_verification_tokens_user_id_index"
    ...
    this.addSql(
      `alter table "user_credentials"
        add constraint "user_credentials_user_id_foreign"
        foreign key ("user_id")
        references "users" ("id")
        on update cascade
        on delete cascade;`,
    ...
    this.addSql(
      `alter table "user_sessions"
        add constraint "user_sessions_user_id_foreign"
        foreign key ("user_id")
        references "users" ("id")
        on update cascade
        on delete cascade;`,
    ...
    this.addSql(
      `alter table "password_reset_tokens"
        add constraint "password_reset_tokens_user_id_foreign"
        foreign key ("user_id")
        references "users" ("id")
        on update cascade
        on delete cascade;`,
    ...
    this.addSql(
      `alter table "email_verification_tokens"
        add constraint "email_verification_tokens_user_id_foreign"
        foreign key ("user_id")
        references "users" ("id")
        on update cascade
        on delete cascade;`,
  ...
  override async down(): Promise<void> {
    this.addSql(
      `alter table "user_credentials"
        drop constraint "user_credentials_user_id_foreign";`,
    );
    this.addSql(
      `alter table "user_sessions"
        drop constraint "user_sessions_user_id_foreign";`,
    );
    this.addSql(
      `alter table "password_reset_tokens"
        drop constraint "password_reset_tokens_user_id_foreign";`,
    );
    this.addSql(
      `alter table "email_verification_tokens"
        drop constraint "email_verification_tokens_user_id_foreign";`,
    );
    this.addSql(
      `alter table "user_roles"
        drop constraint "user_roles_user_id_foreign";`,
    );
    this.addSql(
      `alter table "user_roles"
        drop constraint "user_roles_role_id_foreign";`,
    );
    this.addSql(
      `alter table "role_permissions"
        drop constraint "role_permissions_role_id_foreign";`,
    );
    this.addSql(
      `alter table "role_permissions"
        drop constraint "role_permissions_permission_id_foreign";`,
    );
